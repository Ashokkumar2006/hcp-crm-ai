    ...
    prompt = [
        {
            ...
            "content": (
                ...
                "If they're asking to change/correct ANY field on an already-open interaction - "
                "including who the HCP is, the date/time, the interaction type/format "
                "(meeting, call, email, conference, sample drop), materials/samples, sentiment, "
                "topics, attendees, or outcomes - use edit_interaction. "
